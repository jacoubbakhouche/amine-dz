        ...
        <div className="min-h-screen bg-mesh flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-bold font-heading text-white mb-3">Create Account</h2>
                    <p className="text-white/50 font-medium">Join our professional medical platform</p>
                </div>
                ...
                <p className="text-center text-white/40 text-sm font-medium">
                    Already have an account? <Link to="/login" className="text-white font-bold hover:text-primary-400">Sign In</Link>
                </p>
            </motion.div>
        </div >
    );
